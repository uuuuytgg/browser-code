...
declare const BROWSER_CODE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof BROWSER_CODE_CLI_NAME === "string" ? BROWSER_CODE_CLI_NAME : "browser-code", {
  description: "Browser Code 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
