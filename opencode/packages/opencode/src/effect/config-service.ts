 ...
 *   {
 *     password: Config.string("BROWSER_CODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("BROWSER_CODE_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *
