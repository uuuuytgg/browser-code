...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.BROWSER_CODE_WEBSEARCH_PROVIDER === "exa" || process.env.BROWSER_CODE_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.BROWSER_CODE_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("BROWSER_CODE_EXPERIMENTAL") || truthy("BROWSER_CODE_ENABLE_EXA") || truthy("BROWSER_CODE_EXPERIMENTAL_EXA"),
    enableParallel: truthy("BROWSER_CODE_ENABLE_PARALLEL") || truthy("BROWSER_CODE_EXPERIMENTAL_PARALLEL"),
