...
declare const BROWSER_CODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof BROWSER_CODE_LIBC === "undefined" ? undefined : BROWSER_CODE_LIBC
...
export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.BROWSER_CODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.BROWSER_CODE_EXPERIMENTAL_FILEWATCHER) {
